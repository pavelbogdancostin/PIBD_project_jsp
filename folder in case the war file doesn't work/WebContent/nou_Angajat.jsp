    ...
    <body>
        <%
            ...
            if (Nume != null) {
                ...
                jb.connect();
                jb.adaugaAngajat(Nume, Prenume, Functie,Experienta,Salariu);
                jb.disconnect();
        %>
        <h1 style="color:blue;" >Ati adaugat un angajat.</h1><%
        } else {
        %>
        ...
        <form action="nou_Angajat.jsp" method="post">
           ...
           <input type="text" name="Prenume" size="30" /><br>
           <label >Functie:</label><br>
           <input type="text" name="Functie" size="30" /><br>
           <label >Experienta [ani]:</label><br>
           <input type="number" name="Experienta" size="30" /><br>
           <label >Salariu [$]:</label><br>
           <input type="number" name="Salariu" size="30" /><br>
           <br>
